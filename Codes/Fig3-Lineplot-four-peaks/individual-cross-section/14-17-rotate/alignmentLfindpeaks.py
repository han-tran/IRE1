...
alingmentendleft = 15
alingmentbeginright = 35
alingmentendright = 45

#Set MinOrMax to one if you are looking for the maximum before inversion, if you are looking for the minimum set to 0
MinOrMax = 0

MainDirectoryLoad = "/Users/HanTran/Box Sync/3_Walter Lab/4_publication_drafts/HT-papers/1-Foci-CLEM/2-Figure/1-HT-tube/SI-V4-lineplot/14-17-rotate"
...
plt.xlim([0,45])
plt.savefig("LinePlot-ring_two-peaks.svg")
plt.savefig("LinePlot-ring_two-peaks.png")
plt.show()
